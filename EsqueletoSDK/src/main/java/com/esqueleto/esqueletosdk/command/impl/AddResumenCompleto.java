 ...
 */
public class AddResumenCompleto implements AddCommand<Resumen> {
    ...
    public AddResumenCompleto(ResumenInteractor resumenInteractor, Cuenta cuenta, String anyMes, Date inicioPeriodo,
    ...
    public Resumen execute(Context ctx) {
        return this.resumenInteractor.addResumenCompleto(ctx, this.cuenta, this.anyMes, this.inicioPeriodo, this.finPeriodo,
